  ...
  switch (timeOfDay) {
    case 'morning':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-amber-100/80 via-orange-50/70 to-yellow-100/60 backdrop-blur-2xl border-amber-300/90 shadow-[0_12px_36px_rgba(245,158,11,0.14)]',
        ...
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(245,158,11,0.28),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(251,191,36,0.22),transparent_65%)]',
        topLight: 'from-transparent via-amber-400 to-transparent',
        shimmerGlow: 'via-amber-400 shadow-[0_0_18px_#f59e0b]',
        orb1: 'from-amber-400/25 via-yellow-200/15 to-transparent',
        orb2: 'from-orange-400/20 via-amber-200/12 to-transparent',
        orb3: 'from-yellow-300/20 via-transparent to-transparent',
    ...
    case 'afternoon':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-teal-100/75 via-emerald-50/70 to-cyan-100/60 backdrop-blur-2xl border-teal-300/90 shadow-[0_12px_36px_rgba(13,148,136,0.14)]',
        ...
        subtitleColor: 'text-slate-700 font-semibold',
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(13,148,136,0.28),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(16,185,129,0.22),transparent_65%)]',
        topLight: 'from-transparent via-teal-400 to-transparent',
        shimmerGlow: 'via-teal-400 shadow-[0_0_18px_#2dd4bf]',
        orb1: 'from-teal-400/25 via-emerald-200/15 to-transparent',
        orb2: 'from-cyan-300/20 via-teal-100/12 to-transparent',
        orb3: 'from-sky-200/20 via-transparent to-transparent',
    ...
    case 'evening':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-orange-100/80 via-rose-50/70 to-amber-100/60 backdrop-blur-2xl border-orange-300/90 shadow-[0_12px_36px_rgba(249,115,22,0.14)]',
        ...
        subtitleColor: 'text-slate-700 font-semibold',
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(249,115,22,0.28),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(244,63,94,0.22),transparent_65%)]',
        topLight: 'from-transparent via-orange-400 to-transparent',
        shimmerGlow: 'via-orange-400 shadow-[0_0_18px_#f97316]',
        orb1: 'from-orange-400/25 via-amber-200/15 to-transparent',
        orb2: 'from-rose-300/20 via-orange-100/12 to-transparent',
        orb3: 'from-amber-200/20 via-transparent to-transparent',
