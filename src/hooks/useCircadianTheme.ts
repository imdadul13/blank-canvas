  ...
  switch (timeOfDay) {
    case 'morning':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-amber-500/[0.14] via-orange-500/[0.04] to-yellow-500/[0.08] backdrop-blur-2xl border-amber-300/90 shadow-[0_12px_36px_rgba(245,158,11,0.12)]',
        ...
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(245,158,11,0.24),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(251,191,36,0.18),transparent_65%)]',
        topLight: 'from-transparent via-amber-400 to-transparent',
        shimmerGlow: 'via-amber-400 shadow-[0_0_18px_#f59e0b]',
        orb1: 'from-amber-400/20 via-yellow-200/12 to-transparent',
        orb2: 'from-orange-400/15 via-amber-200/10 to-transparent',
        orb3: 'from-yellow-300/15 via-transparent to-transparent',
    ...
    case 'afternoon':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-teal-500/[0.14] via-emerald-500/[0.04] to-cyan-500/[0.08] backdrop-blur-2xl border-teal-300/90 shadow-[0_12px_36px_rgba(13,148,136,0.12)]',
        ...
        subtitleColor: 'text-slate-700 font-semibold',
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(13,148,136,0.24),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(16,185,129,0.18),transparent_65%)]',
        topLight: 'from-transparent via-teal-400 to-transparent',
        shimmerGlow: 'via-teal-400 shadow-[0_0_18px_#2dd4bf]',
        orb1: 'from-teal-400/20 via-emerald-200/12 to-transparent',
        orb2: 'from-cyan-300/15 via-teal-100/10 to-transparent',
        orb3: 'from-sky-200/15 via-transparent to-transparent',
    ...
    case 'evening':
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-orange-500/[0.14] via-rose-500/[0.04] to-amber-500/[0.08] backdrop-blur-2xl border-orange-300/90 shadow-[0_12px_36px_rgba(249,115,22,0.12)]',
        ...
        subtitleColor: 'text-slate-700 font-semibold',
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_12%_15%,rgba(249,115,22,0.24),transparent_65%),radial-gradient(ellipse_65%_55%_at_88%_85%,rgba(244,63,94,0.18),transparent_65%)]',
        topLight: 'from-transparent via-orange-400 to-transparent',
        shimmerGlow: 'via-orange-400 shadow-[0_0_18px_#f97316]',
        orb1: 'from-orange-400/20 via-amber-200/12 to-transparent',
        orb2: 'from-rose-300/15 via-orange-100/10 to-transparent',
        orb3: 'from-amber-200/15 via-transparent to-transparent',
    ...
    default:
      return {
        ...
        bannerBg: 'bg-gradient-to-br from-[#060D18] via-[#0B1829] to-[#081220] backdrop-blur-2xl border-sky-500/40 shadow-[0_16px_50px_rgba(2,6,23,0.8),0_0_30px_rgba(56,189,248,0.15)]',
        ...
        auraGrad: 'bg-[radial-gradient(ellipse_75%_65%_at_15%_15%,rgba(56,189,248,0.30),transparent_70%),radial-gradient(ellipse_70%_60%_at_85%_85%,rgba(99,102,241,0.24),transparent_70%)]',
