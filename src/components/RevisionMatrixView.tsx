  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 rounded-2xl border border-slate-200/90 bg-white/90 backdrop-blur-xl p-5 sm:p-6 shadow-[0_4px_24px_rgba(0,107,99,0.04)] flex flex-col justify-between space-y-5">
          {/* Card Header */}
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white/90 backdrop-blur-xl p-5 sm:p-6 shadow-[0_4px_24px_rgba(0,107,99,0.04)] space-y-5">
            {/* Header */}
      ...
      {isCalendarModalOpen &&
        createPortal(
          ...
          <div className="w-full max-w-xl bg-white/95 backdrop-blur-2xl rounded-3xl border border-slate-200/90 shadow-[0_25px_60px_rgba(0,107,99,0.12)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            {/* Modal Header */}
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              ...
              <button
                ...
                className="p-1.5 rounded-lg text-slate-400 hover:text-slate-600 bg-slate-100/90 hover:bg-white border border-slate-200/90 shadow-2xs transition-colors backdrop-blur-sm cursor-pointer"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
