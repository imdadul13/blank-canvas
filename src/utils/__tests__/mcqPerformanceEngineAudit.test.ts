...
async function runMcqPerformanceEngineAudit() {
  ...
  const TARGET_5_TOPICS = [
    ...
    },
    {
      ...
      expectedKeywords: ['cholinergic', 'atropine', 'pralidoxime', 'adrenergic', 'organophosphate', 'glucagon', 'propranolol', 'agonist', 'antagonist', 'autonomic', 'pharmacology', 'warfarin', 'clarithromycin', 'cyp'],
    },
  ];
