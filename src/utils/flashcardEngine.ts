...
export const VERIFIED_TOPIC_FLASHCARDS: Record<string, Omit<FlashcardItem, 'id' | 'topicId' | 'subjectId'>[]> = {
  ...
  'psm-2': [
    {
      front: 'What are the most heat-sensitive and most freeze-sensitive vaccines in the Universal Immunization Programme (UIP)?',
      back: 'Most Heat Sensitive: OPV (Oral Polio Vaccine), followed by Rotavirus, Measles/MR, and BCG.\nMost Freeze Sensitive: Hepatitis B, followed by Td, DPT, and Pentavalent.',
      clinicalPearl: 'Never freeze T-series vaccines (Hepatitis B, DPT, TT/Td, Pentavalent). If frozen, they lose potency irreversibly.',
      category: 'Cold Chain & UIP',
      difficulty: 'high-yield',
    },
    {
      front: 'How is the Shake Test performed and what result indicates vaccine damage?',
      back: 'Freeze-thawed test vial vs suspected vial shaken vigorously. If the suspected vial sediment settles FASTER than the control vial, it indicates the vaccine was frozen and damaged (Positive Shake Test -> Discard).',
      clinicalPearl: 'Positive Shake Test = sedimentation faster in test vial = vaccine damaged, discard.',
      category: 'Vaccine Quality Control',
      difficulty: 'high-yield',
    },
    {
      front: 'What are the 4 stages of Vaccine Vial Monitor (VVM) and at which stage must the vaccine be discarded?',
      back: 'Stage 1: Inner square lighter than outer circle (Usable).\nStage 2: Inner square still lighter than outer circle (Usable, prioritize).\nStage 3: Inner square matches color of outer circle (DO NOT USE / Discard).\nStage 4: Inner square darker than outer circle (DO NOT USE / Discard).',
      clinicalPearl: 'Discoloration of VVM is irreversible and measures cumulative heat exposure, not freezing.',
      category: 'VVM Interpretation',
      difficulty: 'high-yield',
    },
    {
      front: 'What is an Ice-Lined Refrigerator (ILR) and what is the optimal storage temperature inside it?',
      back: 'ILR maintains temperature between +2°C to +8°C during electrical failure for up to 24-72 hours via surrounding frozen ice packs.\nBottom is coldest, top/basket is warmer.',
      clinicalPearl: 'Never place freeze-sensitive vaccines at the bottom of an ILR where temperatures drop near 0°C.',
      category: 'Cold Chain Equipment',
      difficulty: 'core',
    },
    {
      front: 'What is the role of Deep Freezers at district and PHC levels in the cold chain system?',
      back: 'Maintains temperature between -15°C to -25°C. Primarily used for freezing ice packs and long-term storage of OPV at district stores.\nNever used for storing reconstituted or freeze-sensitive vaccines.',
      clinicalPearl: 'Conditioned ice packs (sweating with water droplets) must be used in vaccine carriers to avoid freezing vaccines.',
      category: 'Cold Chain Equipment',
      difficulty: 'high-yield',
    },
  ],
