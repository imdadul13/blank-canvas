              ...
              >
                ...
                {activeTab === 'syllabus' && (
                  <SyllabusView
                    ...
                    subTab="curriculum"
                    onSubTabChange={(tab) => {
                      if (tab === 'curriculum') handleSetActiveTab('syllabus');
                      if (tab === 'revision') handleSetActiveTab('revision');
                    }}
                    onNavigateTab={handleSetActiveTab}
                  />
                )}
                ...
                {activeTab === 'errors' && (
                  <ProgressView
                    ...
                    subTab="errors"
                    onSubTabChange={(tab) => {
                      if (tab === 'overview') handleSetActiveTab('progress');
                      if (tab === 'errors') handleSetActiveTab('errors');
                      if (tab === 'predictor') handleSetActiveTab('predictor');
                    }}
                  />
                )}
