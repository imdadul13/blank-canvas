  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col lg:flex-row selection:bg-slate-900 selection:text-white">
      ...
      <div className="relative flex-1 flex flex-col min-w-0 overflow-x-hidden">
        {/* System-Wide Ambient Time-Based Study Artwork Backdrop (Desktop) */}
        {bgOpacity > 0 && (
          <div
            key={activeBg.id}
            className="hidden xl:block pointer-events-none fixed top-0 right-0 w-[58vw] max-w-[840px] h-[740px] z-0 transition-all duration-700 ease-in-out"
            style={{
              opacity: bgOpacity,
              ...
              maskImage:
                'radial-gradient(ellipse 95% 90% at 92% 8%, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.55) 45%, rgba(0,0,0,0.18) 75%, rgba(0,0,0,0) 100%)',
              WebkitMaskImage:
                'radial-gradient(ellipse 95% 90% at 92% 8%, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.55) 45%, rgba(0,0,0,0.18) 75%, rgba(0,0,0,0) 100%)',
            }}
          />
